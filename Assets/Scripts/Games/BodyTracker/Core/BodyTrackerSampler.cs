...
public class BodyTrackerSampler : MonoBehaviour
{
    ...
    public float[] skeletonLens;

    private Dictionary<int, Quaternion> rotationDict;
    ...
    private int leftTouchGroundAction;
    private int rightTouchGroundAction;
    private int leftToeTouchGroundAction;
    private int rightToeTouchGroundAction;
    ...
    {
        rotationDict = new Dictionary<int, Quaternion>();
    ...
    [ContextMenu(nameof(FindBonesReference))]
    public void FindBonesReference()
    {
        bonesList = new List<Transform>(new Transform[22])
        {
            [0] = GameObject.Find(this.name + "/RIG/DeformationSystem/Root/GlobalScale/Hips").transform,
            [1] = GameObject.Find(this.name + "/RIG/DeformationSystem/Root/GlobalScale/Hips/UpLeg_L").transform,
            [2] = GameObject.Find(this.name + "/RIG/DeformationSystem/Root/GlobalScale/Hips/UpLeg_R").transform,
            [3] = GameObject.Find(this.name + "/RIG/DeformationSystem/Root/GlobalScale/Hips/Spine1").transform,
            [4] = GameObject.Find(this.name + "/RIG/DeformationSystem/Root/GlobalScale/Hips/UpLeg_L/Leg_L")
                .transform,
            [5] = GameObject.Find(this.name + "/RIG/DeformationSystem/Root/GlobalScale/Hips/UpLeg_R/Leg_R")
                .transform,
            [6] = GameObject.Find(this.name + "/RIG/DeformationSystem/Root/GlobalScale/Hips/Spine1/Spine2")
                .transform,
            [7] = GameObject.Find(this.name + "/RIG/DeformationSystem/Root/GlobalScale/Hips/UpLeg_L/Leg_L/Foot_L")
                .transform,
            [8] = GameObject.Find(this.name + "/RIG/DeformationSystem/Root/GlobalScale/Hips/UpLeg_R/Leg_R/Foot_R")
                .transform,
            [9] = GameObject.Find(this.name + "/RIG/DeformationSystem/Root/GlobalScale/Hips/Spine1/Spine2/Chest")
                .transform,
            [10] = GameObject
                .Find(this.name +
    ...
    [ContextMenu(nameof(FindBonesLength))]
    public void FindBonesLength()
    {
        skeletonLens = new float[11];
